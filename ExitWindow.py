...
class ExitWindow(QMainWindow):
    ...
    def init_ui(self):
        ...
        self.playButton.setStyleSheet(
            "background-color: #33ffff;""font: 25pt Comic Sans MS;""color: black;""border-radius: 20px;")
        self.playButton.clicked.connect(lambda: self.onPlayPressed())

        # Choose name style sheet
        self.choose_name.setStyleSheet(
            "background: transparent;""font: 25pt Comic Sans MS;""color: white;""border-radius: 20px;")
